...
public class Task_01_Climb_the_Peaks {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        ArrayDeque<String> peaksName = new ArrayDeque<>(Arrays.asList("Vihren", "Kutelo", "Banski Suhodol", "Polezhan", "Kamenitza"));
        HashMap<String, Integer> peakAndLevel = new LinkedHashMap<>(Map.of(
                "Vihren", 80,
                "Kutelo", 90,
                "Banski Suhodol", 100,
                "Polezhan", 60,
        ...
        while (!peakAndLevel.isEmpty() && !foodPortions.isEmpty() && !staminaQuan.isEmpty()) {
            String currentPeakName = peaksName.getFirst();
            if (foodPortions.getLast() + staminaQuan.getFirst() >= peakAndLevel.get(currentPeakName)) {
                ...
                peaksName.remove(currentPeakName);
            } else {
                staminaQuan.removeFirst();
                foodPortions.removeLast();
            }
